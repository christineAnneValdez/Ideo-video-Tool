...
"%JAVA%" %KC_OPTS% -cp "%DIRNAME%\client\keycloak-admin-cli-24.0.5.jar" --add-opens=java.base/java.security=ALL-UNNAMED -Dkc.lib.dir="%DIRNAME%\client\lib" org.keycloak.client.admin.cli.KcAdmMain %*
